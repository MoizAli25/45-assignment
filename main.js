...
let friends = ['Ali', 'Ahmed', 'Faraz', 'Bilal', 'Anas', 'Moiz'];
...
let friends1 = ['Ali', 'Ahmed', 'Faraz', 'Bilal', 'Anas', 'Moiz'];
let message1 = "Good to see you";
for (let i = 0; i < friends.length; i++) {
    console.log(`${message1} ${friends1[i]}`);
}
// Question # 13: Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
let transportation = ['Honda civic', 'land cruiser', 'hayabusa bike', 'toyota corolla', 'vespa bike'];
let message2 = "I would like to own";
for (let i = 0; i < transportation.length; i++) {
    console.log(`${message2} ${transportation[i]}`);
}
// Question # 14: Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
let guests_list = ['Ali', 'Ahmed', 'Faraz'];
let message3 = "You are invited to a dinner tonight.";
...
let guests_list1 = ['Ali', 'Ahmed', 'Faraz', 'Bisma', 'Laiba'];
let message5 = "You are invited to a dinner tomorrow.";
let excludedGuest0 = "Ahmed";
let newGuest0 = "Sohail";
...
let guests_list2 = ['Ali', 'Ahmed', 'Faraz', 'Bisma',];
let message4 = "\n You are invited to a dinner tomorrow. \n";
let excludedGuest = "Ahmed";
let newGuest = "Sohail";
...
let guests_list3 = ['Ali', 'Ahmed', 'Faraz', 'Bisma',];
let excludedGuest1 = "Ahmed";
...
let places = ['Baku ', 'Spain ', 'Dubai ', 'Turkey ', 'France '];
...
let guests_list4 = ['Ali', 'Ahmed', 'Faraz'];
...
let lang = ['Urdu', 'English', 'Chinese', 'Hindi', 'Arabic', "Russian"];
...
let userNames = ['Admin', 'Feroz', 'Rameen', 'Bilal', 'Haroon', 'Bisma'];
...
let users = ['hamza', 'feroz', 'ahmed', 'sana', 'dua', 'laiba'];
if (users.length === 0) {
...
let current_users = ['hamza', 'feroz', 'ahmed', 'sana', 'dua', 'laiba'];
let new_users = ['ali', 'feroz', 'kamran', 'sadia', 'jawad', 'laiba'];
...
let pizzaFlav = ['chicken fajita', 'pepperoni', 'chicken tikka'];
...
console.log(album2);
console.log(album3);
function make_album2(artistName, album_title, tracks) {
...
let modifiedMagicians = make_great0([...originalMagicians]);
...
function who_create_Car1(manufacturer, model, ...properties) {
    const car = {
        manufacturer,
        model,
    };
